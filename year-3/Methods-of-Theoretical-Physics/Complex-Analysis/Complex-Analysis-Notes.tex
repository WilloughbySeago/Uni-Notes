...
%    \end{example}
    ...
    \begin{definition}{Sequence}{}
        A \define{sequence} is a function whose domain is an interval of integers, i.e. \(a\colon[a, b]\intersection\integers\to X\).
    \end{definition}
    ...
    \begin{figure}
        ...
        \begin{subfigure}{\textwidth}
            \centering
            \includegraphics[scale=0.9]{exp-1-div-z-high-zoom.pdf}

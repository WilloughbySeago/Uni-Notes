...
\begin{document}
    ...
    \begin{exm}{}{}
        ...
        This is simply the adjoint representation of \(\specialUnitaryLie(2)\) as defined above, so clearly these two Lie algebras are the same.
    ...
    \begin{equation}
        D g^{-1} \overbar{g} = g^{-1}\overbar{g} D,
    \end{equation}
    so \(g^{-1}\overbar{g}\) commutes with all \(D\) in the adjoint representation.
    We can now apply the following famous result.
    ...
    \begin{lma}{Schur's Lemma}{}
        ...
        \begin{proof}
            See \course{Symmetries of Quantum Mechanics} notes.
        \end{proof}
    \end{lma}

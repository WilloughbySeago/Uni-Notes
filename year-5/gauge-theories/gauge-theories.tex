...
\begin{document}
    ...
    \begin{equation}
        p^\mu = xP^\mu
    \end{equation}
    where \(P^\mu\) is the momentum of the proton and \(x\) is the \defineindex{momentum fraction} of the parton, the fraction of the momentum that single parton carries.

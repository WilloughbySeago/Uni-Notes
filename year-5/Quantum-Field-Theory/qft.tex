...
%    \end{equation}
    ...
    \end{align}
    Note that the sign is the opposite to the sign in \((\slashed{p} - m)u = (\slashed{v} + m)v = 0\).
   ...
   \end{equation}
    ...
    \end{equation}
    where \(\Delta_{\feynman}\) is the Feynman propagator for a scalar field, and \(S_F(x)\) is the \defineindex{Feynman propagator} for a fermion field.
    ...
    \begin{equation}
        ...
        \begin{tikzpicture}[>={Latex}]
            \draw (0, 1) node [left] {\(p\)} -- (3, 1) node [right] {\(q\)};
            \draw (0, -1) node [left] {\(p'\)} -- (3, -1) node [right] {\(q'\)};
    ...
    \begin{equation}
        ...
        \begin{tikzpicture}[>={Latex}]
            \draw (0, 1) node [left] {\(p\)} -- (1.5, 1) -- (3, -1) node [right] {\(q'\)};
    ...
    \begin{equation}
        \amplitude^\hermit \amplitude = \amplitude_t^\hermit \amplitude_t^\hermit + \amplitude_u^\hermit \amplitude_u^\hermit - (\amplitude_t^\hermit \amplitude_u + \amplitude_u^\hermit \amplitude_t).
    \end{equation}
    ...
    \begin{equation}
        \amplitude_t = -y^2\diracadjoint{u}(\vv{q}, s) u(\vv{p}, s) \diracadjoint{u}(\vv{q}', s') u(\vv{p}', s').
    \end{equation}
    The amplitude for the \(u\)-channel process is
    \begin{equation}
        \amplitude_u = -y^2 \diracadjoint{u}(\vv{q}', s) u(\vv{p}, s) \diracadjoint{u}(\vv{q}, s') u(\vv{p}', s').
    \end{equation}
    
    Hence,
    \begin{align}
        \sum_{s, s'}\amplitude_t^\hermit \amplitude_t &= y^4 \sum_{s, s'} \diracadjoint{u}(\vv{p}', s') u(\vv{q}', s') \diracadjoint{u}(\vv{p}, s) u(\vv{q}, s) \notag\\
        &\qquad \times\diracadjoint{u}(\vv{q}, s) u(\vv{p}, s) \diracadjoint{u}(\vv{q}', s') u(\vv{p}', s')\\
        &= y^4 \sum_{s, s'} \tr[u(\vv{p}, s)\diracadjoint{u}(\vv{p}, s) u(\vv{q}, s) \diracadjoint{u}(\vv{q}, s)] \notag\\
        &\qquad \times\tr[u(\vv{p}', s')\diracadjoint{u}(\vv{p}', s') u(\vv{q}', s') \diracadjoint{u}(\vv{q}', s')]\\
        &= y^4 \tr[(\slashed{p}' + m)(\slashed{q}' + m)] \tr[(\slashed{p} + m)(\slashed{q} + m)]
    \end{align}
    We can calculate both traces the same:
    \begin{align}
    ...
    So, we have
    \begin{equation}
        \sum_{s, s'} \amplitude_t^\hermit \amplitude_t = 16(p' \cdot q' + 4m^2)(p \cdot q + 4m^2).
    \end{equation}
    
    Similarly, for the \(u\)-channel process we have
    \begin{align}
        \sum_{s, s'} \amplitude_u^\hermit \amplitude_u &= y^4 \sum_{s, s'} \diracadjoint{u}(\vv{p}', s') u(\vv{q}, s') \diracadjoint{u}(\vv{p}, s) u(\vv{q}', s) \notag\\
        &\qquad\times\diracadjoint{u}(\vv{q}', s) u(\vv{p}, s) \diracadjoint{u}(\vv{q}, s') u(\vv{p}', s')\\
        &= y^4 \sum_{s, s'} \tr[u(\vv{p}, s)\diracadjoint{u}(\vv{p}, s)u(\vv{q}', s)\diracadjoint{u}(\vv{q}', s)]\\
        &\qquad \times \tr[u(\vv{p}', s')\diracadjoint{u}(\vv{p}', s') u(\vv{q}, s') \diracadjoint{u}(\vv{q}, s')]\\
        &= y^4\tr[(\slashed{p} + m)(\slashed{q}' + m)] \tr[(\slashed{p}' + m)(\slashed{q} + m)]\\
        &= 16y^4(p \cdot q' + 4m^2)(p' \cdot q + 4m^2).
    \end{align}
    
    The first cross term is
    \begin{align}
        \sum_{s, s'} \amplitude_t^\hermit \amplitude_u &= y^4 \sum_{s, s'} \diracadjoint{u}(\vv{p}', s') u(\vv{q}', s') \diracadjoint{u}(\vv{p}, s) u(\vv{q}, s) \notag\\
        &\qquad \times \diracadjoint{u}(\vv{q}', s) u(\vv{p}, s) \diracadjoint{u}(\vv{q}, s') u(\vv{p}', s')\\
        &= y^4 \sum_{s, s'} \tr[u(\vv{p}, s) \diracadjoint{u}(\vv{p}, s) u(\vv{q}, s) \diracadjoint{u}(\vv{q}', s)] \notag\\
        &\qquad \times \tr[u(\vv{p}', s')\diracadjoint{u}(\vv{p}', s') u(\vv{q}', s') \diracadjoint{u}(\vv{q}, s')]
    \end{align}
    \textcolor{red}{How do we deal with spin sums where the momenta aren't the same?}
    ...
    \end{equation}
    is the \defineindex{Feynman propagator}.
    ...
    \section{Correlators in Momentum Space}

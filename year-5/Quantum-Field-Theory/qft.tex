...
%    \end{equation}
   ...
   \end{equation}
    ...
    \section{Amplitude}
    \epigraph{They're dam clever these particles, they know what's going on.}
    ...
    The reason we don't have to consider this diagram is that it is not \defineindex{one particle irreducible}, or 1PI\glossary[acronym]{1PI}{One Particle Irreducible}, meaning that by removing a single propagator we get a disconnected diagram.
...
%            \node at (7.75, 0) {\({} + \mathrlap{\dotsb}\)};
    ...
    This gives the first renormalisation condition: \(\Pi(m_{\renormalised}^2) = 0\) \textcolor{red}{WHY?}.

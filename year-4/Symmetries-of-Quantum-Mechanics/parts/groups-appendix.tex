...
\begin{dfn}{}{}
    The \define{trivial group}\index{trivial!group} is the group containing only the identity, \(\{e\}\).
...
\begin{dfn}{}{dfn:cyclic group}
    The \define{cyclic group}\index{cyclic!group} of order \(n\), denoted \(\integers_n\), is given by the presentation
    \begin{equation}
...
\begin{dfn}{}{dfn:permutation group}
    The \define{permutation group}\index{permutation!group} on \(n\) objects is the group of all permutations (bijections) of \(\{1, \dotsc, n\}\), with function composition as the group operation.
...
\begin{dfn}{}{}
    The \define{orthogonal group}\index{orthogonal!group}\index{O(n)@\(\orthogonal(n)\), orthogonal group}
    \begin{equation}
...
\begin{dfn}{}{}
    The \define{unitary group}\index{unitary!group}\index{U(n)@\(\unitary(n)\), unitary group}
    \begin{equation}

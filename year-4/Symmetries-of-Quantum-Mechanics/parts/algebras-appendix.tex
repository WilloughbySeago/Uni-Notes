...
\begin{dfn}{Tensor Algebra}{}
    ...
    The \defineindex{tensor algebra}, \(T(V)\), is then defined as the direct sum
    \begin{equation}
...
\begin{dfn}{Universal Enveloping Algebra}{}
    ...
    We define the \defineindex{universal enveloping algebra}, \(U(\lie{g})\), to be the quotient space
    \begin{equation}

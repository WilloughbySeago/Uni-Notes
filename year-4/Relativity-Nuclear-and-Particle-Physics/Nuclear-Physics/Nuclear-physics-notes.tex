...
\begin{document}
    ...
    \end{equation}
    Since \(S_\Pn(^236U) = \qty{6.5}{\MeV}\) is greater than the fission barrier height, \qty{6.2}{\MeV}, it is always possible for fission to occur when \ce{^235U} captures a neutron.

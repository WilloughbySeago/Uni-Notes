...
\usepackage[pdfauthor={Willoughby Seago},pdftitle={Modelling and Visualisation in Physics Notes},pdfkeywords={Computational Physics, Computational Modelling, Ising Model, Monte Carlo, Metropolis, Glauber, Kawasaki, Cellular Automata, Game of Life, SIRS Model, PDEs, Cahn-Hilliard Equation},pdfsubject={Statistical Mechanics}]{hyperref}  % Should be loaded second last (cleveref last)
...
\begin{document}
    \frontmatter
    \titlepage
    \innertitlepage{tikz-external/game-of-life-glider.pdf}
    \tableofcontents
    \listoffigures
    \mainmatter

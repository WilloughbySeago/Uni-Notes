...
\usepackage[pdfauthor={Willoughby Seago},pdftitle={Statistical Physics Notes},pdfkeywords={Statistical Physics, Statistical Mechanics, Ensembles, Entropy, Langevin, Debye-Hückle Theory, Landau Theory, Ising Model},pdfsubject={Statistical Mechanics}]{hyperref}  % Should be loaded second last (cleveref last)
...
\begin{document}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}[samples=100]
            ...
            \begin{scope}
                \clip (-5, -2) rectangle (5, 5);
                \draw[ultra thick, highlight, domain=-2:2] plot (2.4*\x, -1.90323*\x*\x-0.508*\x*\x*\x+\x*\x*\x*\x);
            \end{scope}
        \end{tikzpicture}

...
\begin{document}
    ...
    One set of approximations is the \defineindex{Born--Oppenheimer approximation}, also known as the \define{adiabatic approximation}\index{adiabatic approximation|see{Born--Oppenheimer approximation}}.
    ...
    The \defineindex{Fermi surface} is a surface in reciprocal space which is the boundary occupied and unoccupied states.
